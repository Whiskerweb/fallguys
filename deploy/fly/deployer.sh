...
fly secrets set -a "$BACKEND" --stage \
  ...
  SWAP_ROUTEUR_ADRESSE="${SWAP_ROUTEUR_ADRESSE:-}" SWAP_WETH_ADRESSE="${SWAP_WETH_ADRESSE:-}" \
  DEPOT_MINIMUM_MICROS="${DEPOT_MINIMUM_MICROS:-5000000}" RETRAIT_MINIMUM_MICROS="${RETRAIT_MINIMUM_MICROS:-25000000}" DELAI_PREMIER_RETRAIT_HEURES="${DELAI_PREMIER_RETRAIT_HEURES:-0}" \
